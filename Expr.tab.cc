...
#line 37 "Expr.tab.cc" // lalr1.cc:404
...
#line 51 "Expr.tab.cc" // lalr1.cc:412
// Unqualified %code blocks.
#line 54 "Expr.y" // lalr1.cc:413
...
#line 157 "Expr.tab.cc" // lalr1.cc:413
...
namespace yy {
#line 224 "Expr.tab.cc" // lalr1.cc:479
  ...
  TExpr::TExpr (SymbolTablePtr symTable_yyarg, condStack cond_yyarg, ServiceData &srvData_yyarg, exprValuePtr fieldValue_yyarg, std::string &msg_yyarg)
    :
#if YYDEBUG
      yydebug_ (false),
      yycdebug_ (&std::cerr),
...
#line 188 "Expr.y" // lalr1.cc:636
        { yyoutput << yysym.value.template as< std::string > (); }
#line 782 "Expr.tab.cc" // lalr1.cc:636
        break;
...
#line 789 "Expr.tab.cc" // lalr1.cc:636
        break;
...
#line 796 "Expr.tab.cc" // lalr1.cc:636
        break;
...
#line 188 "Expr.y" // lalr1.cc:636
        { yyoutput << yysym.value.template as< std::string > (); }
#line 803 "Expr.tab.cc" // lalr1.cc:636
        break;
...
#line 810 "Expr.tab.cc" // lalr1.cc:636
        break;
...
#line 188 "Expr.y" // lalr1.cc:636
        { yyoutput << yysym.value.template as< exprValueType > (); }
#line 817 "Expr.tab.cc" // lalr1.cc:636
        break;
...
#line 824 "Expr.tab.cc" // lalr1.cc:636
        break;
  ...
  TExpr::parse ()
  {
    ...
    #line 50 "Expr.y" // lalr1.cc:745
{
    cond.push(true);
}

#line 939 "Expr.tab.cc" // lalr1.cc:745
      ...
      try
        {
          switch (yyn)
            {
  case 2:
#line 192 "Expr.y" // lalr1.cc:859
    { *fieldValue = yystack_[0].value.as< exprValueType > (); }
#line 1065 "Expr.tab.cc" // lalr1.cc:859
    break;

  case 3:
#line 194 "Expr.y" // lalr1.cc:859
    { CHECK_COND;
            yylhs.value.as< exprValueType > () = yystack_[0].value.as< exprValueType > ();
        }
#line 1073 "Expr.tab.cc" // lalr1.cc:859
    break;

  case 4:
#line 197 "Expr.y" // lalr1.cc:859
    { CHECK_COND;
            yylhs.value.as< exprValueType > ().setNone();
        }
#line 1081 "Expr.tab.cc" // lalr1.cc:859
    break;

  case 5:
#line 202 "Expr.y" // lalr1.cc:859
    { CHECK_COND; 
...
#line 1093 "Expr.tab.cc" // lalr1.cc:859
    break;

  case 6:
#line 209 "Expr.y" // lalr1.cc:859
    { CHECK_COND;
...
#line 1102 "Expr.tab.cc" // lalr1.cc:859
    break;

  case 7:
#line 213 "Expr.y" // lalr1.cc:859
    { CHECK_COND; 
            CHECK_TYPE(yystack_[2].value.as< exprValueType > ().isNumber() && yystack_[0].value.as< exprValueType > ().isNumber(), "*");
...
#line 1147 "Expr.tab.cc" // lalr1.cc:859
    break;

  case 12:
#line 233 "Expr.y" // lalr1.cc:859
    { CHECK_COND;
            CHECK_TYPE( (yystack_[2].value.as< exprValueType > ().isNumber() && yystack_[0].value.as< exprValueType > ().isNumber()) || (yystack_[2].value.as< exprValueType > ().isStr() && yystack_[0].value.as< exprValueType > ().isStr()), ">=");
...
#line 1156 "Expr.tab.cc" // lalr1.cc:859
    break;

  case 13:
#line 237 "Expr.y" // lalr1.cc:859
    { CHECK_COND;
            CHECK_TYPE( (yystack_[2].value.as< exprValueType > ().isNumber() && yystack_[0].value.as< exprValueType > ().isNumber()) || (yystack_[2].value.as< exprValueType > ().isStr() && yystack_[0].value.as< exprValueType > ().isStr()), "<");
            expr_bi_op2<std::less>(yylhs.value.as< exprValueType > (),yystack_[2].value.as< exprValueType > (),yystack_[0].value.as< exprValueType > ());
        }
#line 1165 "Expr.tab.cc" // lalr1.cc:859
    break;

  case 14:
#line 241 "Expr.y" // lalr1.cc:859
    { CHECK_COND;
            CHECK_TYPE( (yystack_[2].value.as< exprValueType > ().isNumber() && yystack_[0].value.as< exprValueType > ().isNumber()) || (yystack_[2].value.as< exprValueType > ().isStr() && yystack_[0].value.as< exprValueType > ().isStr()), "<=");
...
#line 1174 "Expr.tab.cc" // lalr1.cc:859
    break;

  case 15:
#line 245 "Expr.y" // lalr1.cc:859
    { CHECK_COND;
...
#line 1186 "Expr.tab.cc" // lalr1.cc:859
    break;

  case 16:
#line 252 "Expr.y" // lalr1.cc:859
    { CHECK_COND;
...
#line 1200 "Expr.tab.cc" // lalr1.cc:859
    break;

  case 17:
#line 261 "Expr.y" // lalr1.cc:859
    { CHECK_COND;
...
#line 1209 "Expr.tab.cc" // lalr1.cc:859
    break;

  case 18:
#line 265 "Expr.y" // lalr1.cc:859
    { CHECK_COND;
            CHECK_TYPE(yystack_[2].value.as< exprValueType > ().isLogical() && yystack_[0].value.as< exprValueType > ().isLogical() , "||");
...
#line 1218 "Expr.tab.cc" // lalr1.cc:859
    break;

  case 19:
#line 269 "Expr.y" // lalr1.cc:859
    { CHECK_COND;
...
#line 1227 "Expr.tab.cc" // lalr1.cc:859
    break;

  case 20:
#line 273 "Expr.y" // lalr1.cc:859
    { CHECK_COND;
...
#line 1236 "Expr.tab.cc" // lalr1.cc:859
    break;

  case 21:
#line 277 "Expr.y" // lalr1.cc:859
    { CHECK_COND;
            CHECK_TYPE(yystack_[2].value.as< exprValueType > ().isInt() && yystack_[0].value.as< exprValueType > ().isInt(), "|");
            yylhs.value.as< exprValueType > ().setInt( yystack_[2].value.as< exprValueType > ().getInt() | yystack_[0].value.as< exprValueType > ().getInt() );
        }
#line 1245 "Expr.tab.cc" // lalr1.cc:859
    break;

  case 22:
#line 281 "Expr.y" // lalr1.cc:859
    { CHECK_COND;
...
#line 1254 "Expr.tab.cc" // lalr1.cc:859
    break;

  case 23:
#line 285 "Expr.y" // lalr1.cc:859
    { CHECK_COND;
...
#line 1266 "Expr.tab.cc" // lalr1.cc:859
    break;

  case 24:
#line 292 "Expr.y" // lalr1.cc:859
    { CHECK_COND;
            yylhs.value.as< exprValueType > () = yystack_[1].value.as< exprValueType > ();
        }
#line 1274 "Expr.tab.cc" // lalr1.cc:859
    break;

  case 25:
#line 295 "Expr.y" // lalr1.cc:859
    { CHECK_COND; yylhs.value.as< exprValueType > ().setInt(yystack_[0].value.as< int > ()); }
#line 1280 "Expr.tab.cc" // lalr1.cc:859
    break;

  case 26:
#line 296 "Expr.y" // lalr1.cc:859
    { CHECK_COND; yylhs.value.as< exprValueType > ().setDouble(yystack_[0].value.as< double > ()); }
#line 1286 "Expr.tab.cc" // lalr1.cc:859
    break;

  case 27:
#line 297 "Expr.y" // lalr1.cc:859
    { CHECK_COND; yylhs.value.as< exprValueType > ().setStr(yystack_[0].value.as< std::string > ()); }
#line 1292 "Expr.tab.cc" // lalr1.cc:859
    break;

  case 28:
#line 298 "Expr.y" // lalr1.cc:859
    { CHECK_COND;
            ServiceFieldPtr sfd=srvData.getField(yystack_[0].value.as< std::string > ());
            if(!sfd){
...
#line 1305 "Expr.tab.cc" // lalr1.cc:859
    break;

  case 29:
#line 306 "Expr.y" // lalr1.cc:859
    { CHECK_COND;
            string fdname=yystack_[3].value.as< std::string > ()+"#"+yystack_[1].value.as< exprValueType > ().getStr();
            ServiceFieldPtr sfd=srvData.getField(fdname);
            if(!sfd){
...
#line 1319 "Expr.tab.cc" // lalr1.cc:859
    break;

  case 30:
#line 315 "Expr.y" // lalr1.cc:859
    { CHECK_COND;
            ServiceFieldPtr rv = ServiceFieldPtr( new(ServiceField) );
            if( symTable->call( yystack_[3].value.as< std::string > (), srvData, yystack_[1].value.as< exprArgsPtr > () , rv ) ){
...
#line 1333 "Expr.tab.cc" // lalr1.cc:859
    break;

  case 31:
#line 324 "Expr.y" // lalr1.cc:859
    {
            if(cond.top()){
...
#line 1349 "Expr.tab.cc" // lalr1.cc:859
    break;

  case 32:
#line 335 "Expr.y" // lalr1.cc:859
    {
            bool if_cond = cond.top();
            cond.pop();
            cond.push( (!if_cond) && cond.top() );
        }
#line 1359 "Expr.tab.cc" // lalr1.cc:859
    break;

  case 33:
#line 340 "Expr.y" // lalr1.cc:859
    {
            yylhs.value.as< exprValueType > () = cond.top() ? yystack_[0].value.as< exprValueType > () : yystack_[3].value.as< exprValueType > (); 
            cond.pop();
        }
#line 1368 "Expr.tab.cc" // lalr1.cc:859
    break;

  case 34:
#line 346 "Expr.y" // lalr1.cc:859
    { CHECK_COND;
...
#line 1377 "Expr.tab.cc" // lalr1.cc:859
    break;

  case 35:
#line 350 "Expr.y" // lalr1.cc:859
    { CHECK_COND;
...
#line 1387 "Expr.tab.cc" // lalr1.cc:859
    break;


#line 1391 "Expr.tab.cc" // lalr1.cc:859
            default:
              break;
            }
        }
...
#undef YYCASE_
  ...
  TExpr::yyrline_[] =
  {
       0,   192,   192,   194,   197,   202,   209,   213,   217,   221,
     225,   229,   233,   237,   241,   245,   252,   261,   265,   269,
     273,   277,   281,   285,   292,   295,   296,   297,   298,   306,
     315,   324,   335,   324,   346,   350
  };
...
#line 1872 "Expr.tab.cc" // lalr1.cc:1167
#line 355 "Expr.y" // lalr1.cc:1168
...
int SDExprEval( ServiceData &srvData, exprValuePtr srvField, const char* sexpr , string &msg )
{
    SymbolTablePtr symTable = SymbolTablePtr( new exprSymbolTable );
    condStack cond;
    YY_BUFFER_STATE buffer = yy_scan_string( sexpr );
    TExpr expr( symTable, cond , srvData, srvField, msg );
